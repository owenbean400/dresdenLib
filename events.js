...
Vue.component("Events", {
  template: `
    <div class="events-container">
        <a v-for="(info, title) in events" class="event-card" :href="info.link">
            <h4 class="date">{{getMonth(info.date) + " " + getDay(info.date) + ", " + info.date.substring(info.date.lastIndexOf("/") + 1, info.date.length)}}</h4>
